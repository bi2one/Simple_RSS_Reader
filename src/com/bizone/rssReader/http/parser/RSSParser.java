...
// import com.bizone.rssReader.exception.JSONRSSException;
// import com.bizone.rssReader.exception.JSONCodeRSSException;
import com.bizone.rssReader.http.request.HttpUtility;
...
public abstract class RSSParser {
    public abstract ArrayList<RSSData> parseToRSSDataList(String data) throws RSSException;
